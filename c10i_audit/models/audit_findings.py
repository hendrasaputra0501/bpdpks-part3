...
class AuditFindings(models.Model):
    ...
    condition = fields.Html('Kondisi')
    criteria = fields.Html('Kriteria')
    cause = fields.Html('Sebab')
    effect = fields.Html('Akibat')
    response = fields.Html('Tanggapan')
    contra_response = fields.Html('Kontra Tanggapan')
